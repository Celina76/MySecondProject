				...
				[
						...
						function(JobService, $scope, $location, $rootScope) {
							...
							self.accept = function(jobapplied, id) {
								...
								JobService
										.accept(jobapplied, id)
										.then(
												self.getAllJobsApplied,
												function(errresponse) {
													console
															.log('Error while accepting jobapplied')
												});
							};
							...
							self.reject = function(jobapplied, id) {
								...
								JobService
										.reject(jobapplied, id)
										.then(
												self.getAllJobsApplied,
												function(errresponse) {
													console
															.log('Error while rejecting jobapplied')
												});
							};
							...
							function applyForJob(jobID) {
								...
								if (typeof currentUser == 'undefined') {
									...
									console
											.log("User not logged in, Cannot apply for job")
									$location.path('/login');
								}
							...
							self.rejectJobApplication = function(userID) {
								...
								console
										.log('calling the method rejectJobApplication of the user'
												+ userID);
								JobService
										.rejectJobApplication(userID,
												selectedJobID)
										.then(
												function(d) {
													self.job = d;
							...
							self.canCallForInterview = function(userID) {
								var jobID = $rootScope.selectedJob.id;
								JobService
										.canCallForInterview(userID, jobID)
										.then(
												function(d) {
													self.job = d;
							...
							self.selectUser = function(userID) {
								...
								console
										.log(
												'calling the method selecteduser with user ID:',
												userID)

								JobService
										.selectUser(userID, selectedJobID)
										.then(
												function(d) {
													self.job = d;
												...
												function(errResponse) {
													console
															.error('Error while changning the status');
												});
							};
							...
							self.getAllJobsApplied = function() {
								console
										.log('calling the method getAllJobsApplied');
								JobService
										.getAllJobsApplied()
										.then(
												function(d) {
							...
							function getJobDetails(jobID) {
								...
								JobService
										...
										.then(
												...
												function(errResponse) {
													console
															.error('Error while fetching job details');
												});
							}
							;
