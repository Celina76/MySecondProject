				...
				[
						...
						function($http, $q, $rootScope) {
							...
							return {
								...
								fetchAllBlogComments : function() {
									return $http
											...
											.then(
													...
													function(errResponse) {
														console
																.error('Error while fetching BlogComments');
														return $q
																.reject(errResponse);
													});
								},
								...
								commentBlog : function(blogcomment, id,
										comment, ratingvalue) {
									console.log("Your comment is "
											+ blogcomment.bcomment)
									return $http
											.post(
													BASE_URL + '/blogcomment/'
															+ id + '/'
															+ comment + '/'
															+ ratingvalue,
													blogcomment)
											.then(
													...
													function(errResponse) {
														console
																.error('Error while creating blogComment');
														return $q
																.reject(errResponse);
													});
								},
								...
								getBlog : function(id) {
									return $http
											...
											.then(
													...
													function(errResponse) {
														console
																.error("Error while getting blog");
														return $q
																.reject(errResponse);
													});
								},
								...
								getBlogComment : function(blogID) {
									return $http
											...
											.then(
													...
													function(errResponse) {
														console
																.error("Error while getting blogcomment");
														return $q
																.reject(errResponse);
													});
								},
