						...
						function($http, $q, $rootScope) {
							...
							return {
								...
								reject : function(user, id) {
									...
									return $http
											...
											.then(
													...
													function(errResponse) {
														console
																.error('Error while rejecting user');
														return $q
																.reject(errResponse);
													});
								},
								...
								updateUser : function(user, id) {
									console
											.log("updating in the service of user")
									return $http
											.put(BASE_URL + '/user/' + user.id,
													user)
											.then(
													function(response) {
														console
																.log("updated the  user in service")
														return response.data;
													},
													function(errResponse) {
														console
								...
								authenticate : function(user) {
									console
											.log("authenticating in userservice")
									return $http
											.post(
													BASE_URL
															+ '/user/authenticate/',
