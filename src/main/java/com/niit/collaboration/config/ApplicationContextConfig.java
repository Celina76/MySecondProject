...
/*------------------------------database connectivity-----------------------------------**/
    ...
    datasource.setUsername("MARRY");
    datasource.setPassword("pass");
    /*------------------------------connecting hibernate properties-----------------------------------**/ 
   Properties connectionProperties = getHibernateProperties();//new Properties();
...
//    connectionProperties.setProperty("hiberanate.formate_sql", "true");
   ...
   /*------------------------------Trigerring transacation btw application and database-----------------------------------**/
   @Autowired
